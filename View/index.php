...
<main>
  ...
  <div class="container">
    ...
    <?php else: ?>
    <h1 class="page-title">Découvrez la prochaine destination de vos rêves</h1>
    <div class="row">
        ...
        <div class="col l6 m6 s12">
          <div class="card hoverable">
            <div class="card-content">
              <h5><a class="grey-text text-darken-2" href="<?=ROOT_URL?>Agence_post_<?=$oPost->id?>.html"><?=htmlspecialchars($oPost->title)?></a></h5>
            ...
            <div class="card-content">
              ...
              <p><a href="<?=ROOT_URL?>Agence_post_<?=$oPost->id?>.html">Voir Plus</a></p>
            </div>
